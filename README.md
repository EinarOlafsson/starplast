...
the same procedure on shuffled data. On the shipped *T. gondii* table 29 strategies
pass their self-test at their defaults, 4 fail and 1 is inconclusive; beside each, the
