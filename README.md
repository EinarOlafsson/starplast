...
pip install -e ".[gpu]"          # and the CUDA stack it can use, if this machine has a card
starplast-install-gpu            # or let it pick the CUDA set for this driver, showing it first
starplast
```
