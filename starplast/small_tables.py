...
SOURCES = (
    ...
    ("escrt_recruitment_xgboost.tsv", "escrt_recruitment_xgboost", False,
     "spaCR screen supplementary data 4, XGBoost gene-level regression coefficient"),
    ("escrt_recruitment_maxvit.tsv", "escrt_recruitment_maxvit", False,
     "spaCR screen supplementary data 5, MaxViT gene-level regression coefficient"),
